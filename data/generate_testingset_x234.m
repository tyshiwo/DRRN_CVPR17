...
size_label = 31;
stride = 31;
savepath = ['../test_Set5_' num2str(size_input) '_x234.h5'];
...
for i = 1 : length(filepaths)
    disp(['d = ' filepaths(i).name '-- count = ' num2str(count)]);
...
%     imshow([im_label_2 im_input_2],[]);
    ...
    disp(['hei,wid = ' num2str(hei_2) ',' num2str(wid_2) '-- count = ' num2str(count)]);
    % scale 3
...
%     imshow([im_label_3 im_input_3],[]);
    ...
    disp(['hei,wid = ' num2str(hei_3) ',' num2str(wid_3) '-- count = ' num2str(count)]);
    % scale 4
...
%     imshow([im_label_4 im_input_4],[]);
    ...
    disp(['hei,wid = ' num2str(hei_4) ',' num2str(wid_4) '-- count = ' num2str(count)]);
end
